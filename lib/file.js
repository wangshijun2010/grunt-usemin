...
//
var getBlocks = function (content, config) {
  ...
  var srcPattern = config && config.options && config.options.srcPattern ? config.options.srcPattern : /(href|src)=["']([^'"]+)["']/;
